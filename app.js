...
function nav(path) {
    ...
    <a href="https://www.youtube.com/watch?v=AE9VfNrH-xU" target="_blank" class="mdui-btn mdui-btn-icon mdui-ripple mdui-ripple-white" mdui-tooltip="{content: 'GoIndex Drive on Github'}">
